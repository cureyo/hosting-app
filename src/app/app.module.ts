...
@NgModule({
  ...
  providers: [{ provide: LocationStrategy, useClass: PathLocationStrategy }, AuthService, AngularFireAuth, AngularFireDatabase,  FbService, Jsonp, FacebookService, FeedbackComponent, ReportUploadComponent, FeedbackFileUploadComponent, MetadataService],
