                ...
                if (user.firstName) {
                  ...
                  this._authService._getUserDataFromCaredOnePatientInsights(this.userId, this.DoctorId)
                    .subscribe(res => {
                      ...
                      this.publicToken = '';
                      this.checkUpForm = this._fb.group({
                        first_Name: [usDat.user.firstName, Validators.required],
                        last_Name: [usDat.user.firstName, Validators.required],
                        Email: [usDat.user.email, Validators.required],
                        phone: [number, Validators.required],
                        DOB: [''],
                        // visit_Type: [, Validators.required],
                        // // description: [, Validators.required],
